# RBE 595 - Robots for Recycling Manipulation Team
This is the repository for the manipulation team currently enrolled in Robots for Recycling, an experimental Robotics Engineering graduate course at Worcester Polytechnic Institute. Many thanks to the team Sulabh Kumra, Shirin Joshi, and Ferat Sahin for developing this codebase. We are using the pre trained models to identify grasps for recyclable objects both offline and online. We have modified the README below to work in this configuration, while citing the previous developers.
...
```bash
$ git clone git@github.com:cooper530/rbe595-manipulation.git
```
...
- Install the requirements and **ensure CUDA/PyTorch versions are compatible with your device**
```bash
$ cd robotic-grasping
