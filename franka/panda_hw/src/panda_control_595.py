...
# =======================================================================================
# =======================================================================================
# 2025-02-17: PASTED IN BELOW FROM /panda_recycling/src/panda_hw/src/panda_control_595.py
# =======================================================================================
# =======================================================================================
# =======================================================================================
...
#         rospy.init_node('panda_traj_node')
#         rospy.sleep(1.0)
#         rospy.loginfo("panda_control_595: Panda Control Node Ready")
...
#         # rospy.sleep(5)
#         # self.grasp(CLOSE)
#         rospy.loginfo("panda_control_595: here")
...
#     def print_current_state(self):
#         # Prints current robot state
#         rospy.loginfo("panda_control_595: ============ Robot state ============")
#         rospy.loginfo("panda_control_595:", self.robot.get_current_state())
#         rospy.loginfo("")
...
#         wpose = self.moveGroup.get_current_pose().pose  # Get current robot pose (Position + Orientation)  (End effector is not considered as a connected part. 
#                                                         # It gives current pose for joint just before the end effector connection.)
#         rospy.loginfo(f"panda_control_595: wpose orientation: {wpose.orientation}")
#         wpose.position.x = posStart[0]
#         wpose.position.y = posStart[1]
#         wpose.position.z = posStart[2]
...
#         # T= np.array([[ 0.99580984,-0.08684218,-0.0286567 , 0.33299418],
#         # [-0.08693175,-0.99621247,-0.00189243, 0.08382966],
#         # [-0.02838382, 0.00437568,-0.99958752, 0.90775953],
#         # [ 0.        , 0.        , 0.        , 1.        ]])


#         rospy.loginfo(f"panda_control_595: target angle before: {posStart[3]}")
...
#         rospy.loginfo(f"panda_control_595: r = {r.as_matrix()}")
...
#         rospy.loginfo(f"panda_control_595: result = {quaternion}")
...
#         rospy.loginfo("panda_control_595: Moving to location: ", round(x,3), ", ", round(y,3), ", ", round(z,3) + " with orientation: ", round(theta,3))
#         self.execute_traj_start([pandaCoordinateArray, xyzArray[3]])    # Move the robot to given location
...
#         rospy.loginfo(f"panda_control_595: grasps received {grasp}")
...
#                 try: 
#                     rospy.loginfo("panda_control_595: Moving to Grasp location")
#                     self.execute_traj_start(start)
#                 except rospy.ROSException as e:
#                     rospy.loginfo(f"Error while moving to start position: {e}")

#                 # move arm so gripper is inside
#                 rospy.loginfo("panda_control_595: should be above grasp, moving gripper now")
...
#                 rospy.loginfo("panda_control_595: Moving to Within Gripper")
...
#                 rospy.loginfo("panda_control_595: Moving to Above location")
#                 self.execute_traj_start(start)

#                 # move to home configuration
#                 rospy.loginfo("panda_control_595: Moving to home")
...
#     rospy.loginfo("panda_control_595: Moving to Start location")
